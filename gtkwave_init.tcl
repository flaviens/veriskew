set signals [list \
    ...
    "top.ariane_tiny_soc.i_ariane_mem_top.i_ariane.i_cva6.i_cache_subsystem.i_adapter.signal_0672" \
    "top.ariane_tiny_soc.i_ariane_mem_top.i_ariane.i_cva6.i_cache_subsystem.i_adapter.signal_1154" \
]
